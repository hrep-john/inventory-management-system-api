...
use App\Http\Resources\ProductPrice\BasicResource;
use App\Http\Resources\ProductPrice\FullResource;
...
class ProductPriceController
{
    ...
    public function __construct(ProductPriceServiceInterface $service)
    {
