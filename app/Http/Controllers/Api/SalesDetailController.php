...
use App\Http\Requests\SalesDetail\StoreRequest;
use App\Http\Requests\SalesDetail\UpdateRequest;
use App\Http\Resources\SalesDetail\BasicResource;
use App\Http\Resources\SalesDetail\FullResource;
...
class SalesDetailController
{
    ...
    public function __construct(SalesDetailServiceInterface $service)
    {
