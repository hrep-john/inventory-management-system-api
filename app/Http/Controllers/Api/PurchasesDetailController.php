...
use App\Http\Requests\PurchasesDetail\StoreRequest;
use App\Http\Requests\PurchasesDetail\UpdateRequest;
use App\Http\Resources\PurchasesDetail\BasicResource;
use App\Http\Resources\PurchasesDetail\FullResource;
...
class PurchasesDetailController
{
    ...
    public function __construct(PurchasesDetailServiceInterface $service)
    {
